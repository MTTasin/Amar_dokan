...
import ActivationPage from './pages/ActivationPage.jsx'; // NEW: Import the activation page
...
        <Route path="/register" element={<AuthLayout><RegisterPage /></AuthLayout>} />
        ...
        <Route path="/activate/:uid/:token" element={<AuthLayout><ActivationPage /></AuthLayout>} />
